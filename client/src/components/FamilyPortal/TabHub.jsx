        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="bg-car-blue text-white p-8 rounded-[2rem] shadow-lg relative overflow-hidden mb-6">
                <div className="relative z-10">
                    <h2 className="text-lg font-bold tracking-widest opacity-90 uppercase mb-2">Bienvenue sur votre espace</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {newsList.length > 0 ? (
                    newsList.map(news => (
                        ...
                        >
                            <div className="h-3 w-full shrink-0" style={{ backgroundColor: news.borderColor || '#0ea5e9' }}></div>
